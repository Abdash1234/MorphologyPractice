 ...
 *
 * Each entry holds the cells recited in the ṣarf ṣaghīr:
 *   نَصَرَ يَنْصُرُ نَصْرًا، نُصِرَ يُنْصَرُ، فَهُوَ نَاصِرٌ وَذَاكَ مَنْصُورٌ،
 *   اُنْصُرْ، لَا تَنْصُرْ، مَنْصَرٌ، مِنْصَرٌ
 *
 * plus the two ism al-tafḍīl cells the printed sheets add as a fifth line.
 *
 * '—' means the cell is not used for that verb (an intransitive verb has no
 * passive or ism al-mafʿūl, most verbs have no ism al-ālah, and so on). The
 * elative comes only from a thulāthī mujarrad verb, so every mazīd form and
 * every rubāʿī has a dash there — and so do the ajwaf, nāqiṣ and lafīf verbs,
 * whose elatives are not the mechanical أَفْعَل of the sheet and are left out
...
(function (global) {
  ...
  const paradigms = {
    ...
    'nsr-I': {
      ...
      tafdilM: 'أَنْصَرُ', tafdilF: 'نُصْرَى'
    },
    'ktb-I': {
      ...
      tafdilM: 'أَكْتَبُ', tafdilF: 'كُتْبَى'
    },
    'drb-I': {
      ...
      tafdilM: 'أَضْرَبُ', tafdilF: 'ضُرْبَى'
    },
    'jls-I': {
      ...
      tafdilM: 'أَجْلَسُ', tafdilF: 'جُلْسَى'
    },
    'fth-I': {
      ...
      tafdilM: 'أَفْتَحُ', tafdilF: 'فُتْحَى'
    },
    'dhhb-I': {
      ...
      tafdilM: 'أَذْهَبُ', tafdilF: 'ذُهْبَى'
    },
    'alm-I': {
      ...
      tafdilM: 'أَعْلَمُ', tafdilF: 'عُلْمَى'
    },
    'sma-I': {
      ...
      tafdilM: 'أَسْمَعُ', tafdilF: 'سُمْعَى'
    },
    'krm-I': {
      ...
      tafdilM: 'أَكْرَمُ', tafdilF: 'كُرْمَى'
    },
    'hsb-I': {
      ...
      tafdilM: 'أَحْسَبُ', tafdilF: 'حُسْبَى'
    },
    ...
    'mdd-I': {
      ...
      tafdilM: 'أَمَدُّ', tafdilF: 'مُدَّى'
    },
    'rdd-I': {
      ...
      tafdilM: 'أَرَدُّ', tafdilF: 'رُدَّى'
    },
    'akhdh-I': {
    ...
    'sal-I': {
      ...
      tafdilM: 'أَسْأَلُ', tafdilF: 'سُؤْلَى'
    },
    'qra-I': {
      ...
      tafdilM: 'أَقْرَأُ', tafdilF: 'قُرْأَى'
    },
    ...
    'wad-I': {
      ...
      tafdilM: 'أَوْعَدُ', tafdilF: 'وُعْدَى'
    },
    'wsl-I': {
      ...
      tafdilM: 'أَوْصَلُ', tafdilF: 'وُصْلَى'
    },
    'qwl-I': {
